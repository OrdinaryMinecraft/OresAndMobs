...
public class EntityRedDragon extends EntityDragon {
            ...
            if (this.canEntityBeSeen(this.targetedEntity))
                ...
                if (this.ticksExisted % 100 == 0)
                {
                    ...
                    for (int i = 0; i < count; i ++) {
                        ...
                        EntitySmallFireball entitySmallFireball = new EntitySmallFireball(this.worldObj, this, d5, d6, d7);
                        double d8 = 4.0D;
                        Vec3 vec3 = this.getLook(1.0F);
                        entitySmallFireball.posX = this.posX + vec3.xCoord * d8;
                        entitySmallFireball.posY = this.posY + (double)(this.height / 2.0F) + 0.5D;
                        entitySmallFireball.posZ = this.posZ + vec3.zCoord * d8;
                        entitySmallFireball.accelerationX *= 3;
                        entitySmallFireball.accelerationY *= 3;
                        entitySmallFireball.accelerationZ *= 3;
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.getHealth() <= 0.0F)
        {
            ...
            this.worldObj.spawnParticle("lava", this.posX + (double)f, this.posY + 2.0D + (double)f1, this.posZ + (double)f2, 0.0D, 0.0D, 0.0D);
        }
        else
        {
    ...
    protected void onDeathUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                this.worldObj.playSoundEffect((int)this.posX, (int)this.posY, (int)this.posZ, "mob.enderdragon.hit", 0.5F, 0.5F);
                this.worldObj.playSoundEffect((int)this.posX, (int)this.posY, (int)this.posZ, "mob.enderdragon.end", 1.0F, 1.0F);
            }
        }
    ...
    public void dropFewItems(boolean hitRecently, int looting) {
        dropItem(ItemRegistry.dragonbone, rand.nextInt(3) + 1);
        dropItem(ItemRegistry.dragonskin, rand.nextInt(3) + 1);
        dropItem(ItemRegistry.dragonblood, rand.nextInt(2) + 1);
        dropItem(ItemRegistry.unknownbook2, rand.nextInt(1));
    }

    @Override
    public void dropRareDrop(int looting) {
        dropItem(ItemRegistry.dragonessense, 1);
    }
