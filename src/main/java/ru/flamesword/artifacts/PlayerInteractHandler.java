...
public class PlayerInteractHandler {
    ...
    public void onTooltipItem(ItemTooltipEvent event) {
        ...
        if (event.itemStack.getTagCompound() != null) {
            if (event.itemStack.getTagCompound().getShort("Indicator") > 0) {
            ...
            if (event.itemStack.getTagCompound().getString("IndicatorLore") != "") {
                String lore = "§8" + event.itemStack.getTagCompound().getString("IndicatorLore") + " " + StatCollector.translateToLocal("tooltip.item.lore");
