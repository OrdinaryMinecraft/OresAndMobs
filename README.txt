Для того чтобы развернуть воркспейс использовать команду 
gradlew setupDecompWorkspace eclipse

После чего в Eclipse выбрать /ordinaryores/eclipse в качестве воркспейса
Остальное найдется само
