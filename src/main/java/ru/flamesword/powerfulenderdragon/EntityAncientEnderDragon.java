...
public class EntityAncientEnderDragon extends EntityDragon {
	...
	public EntityAncientEnderDragon(World par1World) {
		super(par1World);
	}
	...
	private void createEnderPortal(int p_70975_1_, int p_70975_2_)
    {
        ...
        this.worldObj.setBlock(p_70975_1_, b0 - 1, p_70975_2_, Blocks.coal_block);
        ...
        this.worldObj.setBlock(p_70975_1_, b0 - 0, p_70975_2_, Main.dragonchest);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 - 0, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 - 0, p_70975_2_ + 0, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 - 0, p_70975_2_ - 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 - 0, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 - 0, p_70975_2_ + 0, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 - 0, p_70975_2_ - 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 0, b0 - 0, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 0, b0 - 0, p_70975_2_ - 1, Blocks.air);

        this.worldObj.setBlock(p_70975_1_, b0 + 1, p_70975_2_, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 + 1, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 + 1, p_70975_2_ + 0, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 1, b0 + 1, p_70975_2_ - 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 + 1, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 + 1, p_70975_2_ + 0, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ - 1, b0 + 1, p_70975_2_ - 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 0, b0 + 1, p_70975_2_ + 1, Blocks.air);
        this.worldObj.setBlock(p_70975_1_ + 0, b0 + 1, p_70975_2_ - 1, Blocks.air);

        TileEntityDragonChest te = (TileEntityDragonChest) this.worldObj.getTileEntity(p_70975_1_, b0 - 0, p_70975_2_);
        if (Math.random() <= 0.2) {
            te.setInventorySlotContents(0, new ItemStack(Item.getItemFromBlock(Blocks.dragon_egg)));
        }
